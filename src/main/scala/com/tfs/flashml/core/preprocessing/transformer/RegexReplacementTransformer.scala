...
class RegexReplacementTransformer(override val uid: String)
  ...
  def this() = this(Identifiable.randomUID("regex_replace"))

  val sortedRegexMapSeq = new StringArrayArrayParam(this,"regexReplacements","an Array[Array[String]], with 2 elements in the inner array where 1st element is replacement & 2nd element array")
  ...
  def getRegexReplacements: Array[(String,String)] = $(sortedRegexMapSeq).map{case Array(replacement,regex) => (replacement,regex)
